  ...
  return (
    <div>
      ...
      <div className="flex flex-col">
        ...
        <ProjectCard
            projectName="WFR Data Aquisition System"
            projectType="Distributed Data Aquisition for FSAE - 2023"
            img="../daq.png"
            link="https://github.com/Western-Formula-Racing/RaspberryPi-CAN-DAQ-MVP"
          >
            In order to record the plethora of data generated by our car, I created a distributed CAN Bus based data aquisition system 
            using a Raspberry Pi for the central processing. 
          </ProjectCard>
        <ProjectCard
            projectName="wikiNow"
        ...
        <ProjectCard
            projectName="WFR Brake System Plausibility Device"
            projectType="Safety Device for FSAE - 2023"
            link="/projects/BSPD"
            img="../bspd.png"
          >
           In order to insure the safety of the driver, the Brake System Plausibility Device (BSPD)
           uses a set of analog comparators and digital logic gates to shut off the car under certain cut-off conditions.
           <br></br>
           <br></br>
           <br></br>
           <br></br>
